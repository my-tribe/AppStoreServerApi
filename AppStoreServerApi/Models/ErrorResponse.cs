...
)
{
    internal Error MakeTypedError() =>
        ErrorCode switch {
            ...
            4000012 => new StartDateTooFarInPastError(ErrorCode, ErrorMessage),
            4000013 => new StartDateAfterEndDateError(ErrorCode, ErrorMessage),
            4000014 => new InvalidPaginationTokenError(ErrorCode, ErrorMessage),
            4000015 => new InvalidStartDateError(ErrorCode, ErrorMessage),
            4000016 => new InvalidEndDateError(ErrorCode, ErrorMessage),
            4000017 => new PaginationTokenExpiredError(ErrorCode, ErrorMessage),
            4000018 => new InvalidNotificationTypeError(ErrorCode, ErrorMessage),
            4000019 => new MultipleFiltersSuppliedError(ErrorCode, ErrorMessage),
